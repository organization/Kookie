...
dependencies {
    ...
    implementation(group = "org.jetbrains.kotlinx", name = "kotlinx-coroutines-jdk8", version = "1.6.3")
    ...
    // netty
    implementation(group = "io.netty", name = "netty-all", version = "4.1.78.Final")
