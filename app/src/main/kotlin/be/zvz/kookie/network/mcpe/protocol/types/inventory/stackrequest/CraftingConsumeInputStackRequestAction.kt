...
@ItemStackRequestIdentify(ItemStackRequestActionType.CRAFTING_CONSUME_INPUT)
class CraftingConsumeInputStackRequestAction(val count: Int, val source: ItemStackRequestSlotInfo) :
