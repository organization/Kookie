...
@ItemStackRequestIdentify(ItemStackRequestActionType.CREATIVE_CREATE)
class CreativeCreateStackRequestAction(val creativeItemId: Int) : ItemStackRequestAction() {

    override fun write(out: PacketSerializer) {
        out.writeGenericTypeNetworkId(creativeItemId)
    }
