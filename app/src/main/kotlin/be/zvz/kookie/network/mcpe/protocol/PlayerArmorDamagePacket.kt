...
@ProtocolIdentify(ProtocolInfo.IDS.PLAYER_ARMOR_DAMAGE_PACKET)
	...
	var feetSlotDamage: Int|null
	 ...
	 static fun create(?headSlotDamage: Int, ?chestSlotDamage: Int, ?legsSlotDamage: Int, ?feetSlotDamage: Int) : self{
		result = new self
	 ...
	 fun getHeadSlotDamage() : ?Int{ return headSlotDamage }

	 fun getChestSlotDamage() : ?Int{ return chestSlotDamage }

	 fun getLegsSlotDamage() : ?Int{ return legsSlotDamage }

	 fun getFeetSlotDamage() : ?Int{ return feetSlotDamage }
