...
class BlockBreakParticle(val block: Block) : Particle {
    override fun encode(pos: Vector3): List<ClientboundPacket> {
        TODO("Implements after implemented RuntimeBlockMapping")
        // listOf(LevelEventPacket.create(LevelEventPacket.EVENT_PARTICLE_DESTROY, RuntimeBlockMapping.totoRuntimeId(block.getFullId()), pos))
    }
}
