...
class TerrainParticle(val block: Block) : Particle {
    override fun encode(pos: Vector3): List<ClientboundPacket> {
        TODO("Implements after implemented RuntimeBlockMapping")
        // listOf(LevelEventPacket.standardParticle(ParticleIds.TERRAIN, RuntimeBlockMapping.totoRuntimeId(block.getFullId()), pos))
    }
}
