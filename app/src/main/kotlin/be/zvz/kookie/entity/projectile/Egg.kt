...
open class Egg @JvmOverloads constructor(
    location: Location,
    ...
    override val entityNetworkIdentifier: EntityIds = EntityIds.EGG

    override fun onHit(event: ProjectileHitEvent) {
        for (i in 0 until 6) {
            // TODO: world.addParticle(location, ItemBreakParticle(VanillaItems.EGG.item))
        }
    }
}
